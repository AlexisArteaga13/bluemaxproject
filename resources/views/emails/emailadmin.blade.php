...
<head>
    ...
    <title>Bluemax Technologys</title>
...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="bg_color">
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="300" cellpadding="0" cellspacing="0" class="container300">
                    <tr>
                        
                        <td align="center" class="section-img">
                            <a href=""
                                style=" border-style: none !important; display: block; border: 0 !important;"><img
                                    src="https://bluemaxwebs.com/wp-content/uploads/2020/06/cropped-ppp2-1.png"
                                    style="display: block; width: 300px;" width="300" border="0" alt="" /></a>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                <span style="color: #5caad2;">HOLA ADMINISTRADOR WEB</span>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            Tenemos una persona esperando por respuesta de información sobre la empresa. 
                                            Responde sus consultas con el correo de la empresa.
                                            Este correo es replicado a todos los administradores, quien tiene el correo de la empresa, respondale lo más urgente.
                                        </div>
                                        <p>Sus datos:</p>
                                        <p>Nombre: {{$msg->name}}</p>
                                        <p>Su correo: {{$msg->email}}</p>
                                        <p>Su celular: {{$msg->telefono}}</p>
                                        <p>Su asunto: {{$msg->subject}}</p>
                                        <p>Su mensaje: {{$msg->message}}</p>
                                        RESPONDELE CON EL CORREO DE LA EMPRESA, LOGRARÁS QUE EL CLIENTE CONFÍE EN TÍ.
                                    </td>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="mailto:{{$msg->email}}" style="color: #ffffff; text-decoration: none;">RESPONDER</a>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td align="left">
                                        <a href=""
                                            style="display: block; border-style: none !important; border: 0 !important;"><img
                                                ...
                                                src="https://bluemaxwebs.com/wp-content/uploads/2020/06/cropped-ppp2-1.png" alt="" /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            Correo: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">servicios@bluemaxwebs.com</a>

                                        </div>
                                       <!-- <div
                                            style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">

                                            Correo del desarrollador: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">alexisarteagacarhua@gmail.com</a>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Desarrollado por Bluemax Technologys</span>
