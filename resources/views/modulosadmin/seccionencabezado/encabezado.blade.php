...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="titulos">Sección Encabezado</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><i class="fas fa-home"></i></i><a href="{{route('home')}}">Inicio</a>
                    </li>
                    <li class="breadcrumb-item active">Mis encabezados</li>
                </ol>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Datos De Encabezados</h3>
                                    <div class="card-tools">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped dt-responsive tabla"
                                        ...
                                        <tbody>
                                            ...
                                            @include('modulosadmin.seccionencabezado.modal')
                                            @endforeach
                                        </tbody>
                                        </tfoot>
                                    </table>
...
<div id="modalAgregar" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('encabezados.store')}}" method="post" enctype="multipart/form-data">
                {{method_field('post')}}
                {{csrf_field()}}
  ...
  ======================================-->
                    ...
                    <div class="modal-header" style="background:#3c8dbc; color:white">
                        ...
                        <h4 class="modal-title">Nuevo Encabezado</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('imagen') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Imagen de encabezado:</label>
...
<div id="modalEditarEncabezado" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('encabezados.update')}}" method="post" enctype="multipart/form-data">
                {{method_field('put')}}
                {{csrf_field()}}
                <div class="modal-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('imagen') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="imagen" type="file" class="form-control" name="encabezado"
                                        value="{{ old('imagen') }}" autofocus>
