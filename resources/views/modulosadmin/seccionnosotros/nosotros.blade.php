...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="titulos">Sección Nosotros</h1>
            </div>
            <div class="col-sm-6">
                                    ...
                                    <table class="table table-bordered table-striped dt-responsive tabla"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img width="50px" src="{{asset('../storage/app/'.$value->icono)}}">
                                                </td>
                                            ...
                                            @include('modulosadmin.seccionnosotros.modal')
                                            @endforeach
                                        </tbody>
                                        </tfoot>
                                    </table>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('icono') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-4 control-label">Ícono:</label>

                                <div class="col-md-12">
                                    <input required id="icono" type="file" class="form-control" name="icono"
                                        value="{{ old('icono') }}" autofocus>
...
<div id="modalEditarEncabezado" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('nosotros.update')}}" method="post" enctype="multipart/form-data">
                {{method_field('put')}}
                {{csrf_field()}}
                <div class="modal-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('icono') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input id="icono" type="file" class="form-control" name="icono"
                                        value="{{ old('icono') }}" autofocus>
